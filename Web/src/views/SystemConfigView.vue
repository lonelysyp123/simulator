  ...
  <div class="sys-page">
    ...
    <div class="card tip-card">
      ...
      <ul class="tips">
        ...
        <li>设备型号选型独立于工程模式，两者均通过重启生效；未选型的设备类型按 <code>pointmaps/models/{类型}/standard/</code> 解析。组态保存会按 PCS 台数自动切换 LocalControl 点表（2/4/8 台对应 standard / 5.5MW / 10MW），EMU 保持单元直控点表。</li>
      </ul>
    </div>
  </div>
</template>
